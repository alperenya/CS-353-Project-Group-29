            ...
            <div class="row" style="margin-top: 10%;">
                <div class="col">
                    <div class="row">
                        ...
                        <div class="col d-xl-flex justify-content-xl-end align-items-xl-center"><select id="deps" name="deps" style="margin-right: 10px;">
                            ...
                            </select><input type="month" style="margin-right: 10px;"><button class="btn btn-success btn-sm" type="button"  onclick="Foo()" id="search"><span>New Appointment&nbsp;</span><i class="fa fa-search"></i></button></div>
                    </div>
                </div>
            </div>
