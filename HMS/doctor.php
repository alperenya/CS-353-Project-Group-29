            ...
            <div class="row" style="margin-top: 10%;">
                <div class="col">
                    <div class="row">
                        ...
                        <div class="col text-right"><input type="date" style="margin-right: 10px;"><button class="btn btn-danger btn-sm" type="button"><span>Cancel Slot&nbsp;</span><i class="fa fa-times"></i></button></div>
                    </div>
                </div>
            </div>
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tr style="background: rgb(255,151,161);">
                        ...
                        <td>02.02.1997</td>
                        <td><button class="btn btn-success btn-sm" type="button"><span>Re-enable slot&nbsp;</span><i class="fa fa-check"></i></button></td>
                    </tr>
                    <tr>
